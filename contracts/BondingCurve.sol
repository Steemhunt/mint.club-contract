...
contract BancorBondingCurve is BancorFormula {
    ...
    */
    ...
    function getContinuousMintReward(uint _reserveTokenAmount) public view returns (uint) {
        return purchaseTargetAmount(continuousSupply(), reserveBalance(), reserveRatio, _reserveTokenAmount);
    }

    function getContinuousBurnRefund(uint _continuousTokenAmount) public view returns (uint) {
        return saleTargetAmount(continuousSupply(), reserveBalance(), reserveRatio, _continuousTokenAmount);
    }
